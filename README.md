...
## Example1
### Input
app -url=http://country.io/capital.json -url=https://httpbin.org/get -pattern=Dhaka

#### Output
```cassandraql
map[http://country.io/capital.json:1]
map[https://httpbin.org/get:0]
Took 0.891530s to get occurrences from 2 urls
```
...
## Example2
### Input
app -url=http://country.io/capital.json -url=https://httpbin.org/get -pattern=origin

#### Output
```cassandraql
map[http://country.io/capital.json:0]
map[https://httpbin.org/get:1]
Took 0.591530s to get occurrences from 2 urls
```


### https://httpbin.org/get -request
#### Response
```cassandraql
{
  "args": {}, 
  "headers": {
    ...
    "Accept-Language": "de,ru-RU;q=0.9,ru;q=0.8,en-US;q=0.7,en;q=0.6", 
  ...
  "origin": "85.29.160.34, 85.29.160.34", 
  "url": "https://httpbin.org/get"
}
```

### http://country.io/capital.json -request
#### Response
```cassandraql
